...
// Helper to extract fields from raw text
const extractFields = (text) => {
    ...
    if (lines.length > 0) {
        // Naive guess: first non-empty line might be the brand or product name
...
router.post('/', upload.single('image'), async (req, res) => {
    ...
    try {
        ...
        // Return URL for the uploaded file so frontend can display it
